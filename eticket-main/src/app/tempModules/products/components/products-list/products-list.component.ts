...
export class ProductsListComponent implements OnInit {
  ...
  _getProducts(search = '', size = 10, pageNumber = 1) {
    this.isLoading = true;
    this._service.getProduct(this.searchText, size, pageNumber).subscribe(data => {
  ...
  handlePageEvent(pageEvent: PageEvent) {
    ...
    this._getProducts('', this.pageSize, this.pageIndex + 1);
  }
}
